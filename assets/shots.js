...
window.IAR_SHOTS = {
  ...
  'blanc-celestia-2':     shoot('Blanc Celestia', ['1-hero', '2-back', '4-cuff', '5-button']),
  'blanc-dewdrop':        shoot('Moonlight Speckle', ['1-hero', '2-back', '4-cuff', '5-button']),
  ...
  'harbour-blue':         shoot('Cobalt Charm', ['1-hero', '2-back', '4-cuff', '5-button']),
  'indigo-oak':           shoot('Indigo Oak', ['1-hero', '3-view', '4-cuff', '5-button']),
  ...
  'marina-stripe-3':      shoot('Azure Pearls', ['1-hero', '2-back', '4-cuff', '5-button']),
  'midnight-navy':      shoot('Midnight Navy', ['1-hero', '2-view', '3-view', '4-cuff', '5-button']),
  'midnight-speckle':     shoot('Midnight Speckle', ['1-hero', '3-view', '4-cuff', '5-button']),
  'moonlight-speckle':    shoot('Blanc Dewdrop', ['1-hero', '2-view', '3-view', '4-cuff', '5-button']),
  'obsidian':             shoot('Obsidian', ['1-hero', '3-view', '4-cuff', '5-button']),
